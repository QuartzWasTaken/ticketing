...
Ces tests verifient que le use case orchestre correctement
...
class TestCreateUserUseCase:
    """Suite de tests pour la creation d'utilisateurs."""
    ...
    def test_create_user_success(self):
        """Doit creer un utilisateur avec les bonnes proprietes."""
        username = "alice"
    ...
    def test_create_agent_user(self):
        """Doit creer un utilisateur agent."""
    ...
    def test_create_user_with_duplicate_username_raises_error(self):
        """Doit lever une erreur si le username existe deja."""
